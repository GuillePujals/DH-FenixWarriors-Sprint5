...
router.get('/',authAdmMiddleware, controladorproduct.list);
//2. 2. /products/create (GET) Formulario de creación de productos
router.get('/create',authAdmMiddleware, controladorproduct.create);
...
router.get('/:id/edit',authAdmMiddleware, controladorproduct.edit);
//6. /products/:id (PUT) Acción de edición (a donde se envía el formulario)
router.put('/:id/edit',authAdmMiddleware, upload.single('image'),validations, controladorproduct.update);
